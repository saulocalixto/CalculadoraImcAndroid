...
import com.github.saulocalixto.healthme.BancoDeDados.dadosUsuarioDAO;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void addDadosUsuario(View view) {
        ...
        if (dadosInformados) {
            gravaDados(view);
            escondeTeclado(getBaseContext(), view);
        } else {
    ...
    public void escondeTeclado(Context context, View editText) {
